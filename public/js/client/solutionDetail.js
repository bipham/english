...
function showComments(i) {
    var ajaxUrlShowComments = 'http://english.dev/showComments/' + i;
        ...
        success: function (data) {
            ...
            if (jQuery.inArray(i, isExpanded) == -1) {
                ...
                $('#commentArea-' + i).append('<div class="item-reply-cmt" id="replyComment">'
                    ...
                    + '</div>'
                    + '<div class="item-cmt-body">'
                    + '<form action="http://english.dev/enterNewComment" method="POST">'
...
function showKeywords(i) {
    var ajaxUrlShowKeywords = 'http://english.dev/showKeywords/' + i;
